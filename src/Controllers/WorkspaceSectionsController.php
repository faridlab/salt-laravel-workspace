...
namespace SaltWorkspace\Controllers;
 ...
 *  )
 */
class WorkspaceSectionsController extends Controller
{
    protected $modelNamespace = 'SaltWorkspace';
    protected $segment = 'workspace_sections';
